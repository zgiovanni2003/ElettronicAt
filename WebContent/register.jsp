          ...
          <div class="card-body p-5 text-center">
            ...
            <form id="register-form" action="<%=request.getContextPath()%>/register" method="post">
	            <div data-mdb-input-init class="form-outline mb-4">
	              ...
	              <div id="name-error" class="form-text text-danger d-none"></div>
	            </div>
	            ...
	            <div data-mdb-input-init class="form-outline mb-4">
	              ...
	              <div id="surname-error" class="form-text text-danger d-none"></div>
	            </div>
	            ...
	            <div data-mdb-input-init class="form-outline mb-4">
	              ...
	              <label class="form-label" for="typeDate">Data di Nascita</label>
	               <div id="date-error" class="form-text text-danger d-none"></div>
	            </div>
